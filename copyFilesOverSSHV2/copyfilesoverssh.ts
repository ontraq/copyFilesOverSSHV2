...
async function run() {
    ...
    try {
        ...
        const privateKey: string = require("fs").readFileSync(process.env['ENDPOINT_DATA_' + sshEndpoint + '_PRIVATEKEY']); //private key is optional, password can be used for connecting
